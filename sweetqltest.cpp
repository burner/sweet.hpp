...
public:
	...
	Person(const std::string& f, const std::string& l, const std::string& c, 
			...
			const std::string& w) :
		firstname(f), lastname(l), company(c), address(a), address2(a2), 
	...
	const std::string& getAddress2() const { return address2; }
	...
	void setAddress2(const std::string& o) { address2 = o; }
	...
	static SqlTable& table() {
		...
		SqlColumn::sqlColumn<std::string>("Address", 
			&Person::setAddress, 	
			&Person::getAddress),
		SqlColumn::sqlColumn<std::string>("Address2", 
			&Person::setAddress2, 	
			&Person::getAddress2),
